# GEUNavEra – Your Campus Navigation Assistant
**Type:** Team Project  
...
**GEUNavEra** is a smart campus navigation web app built using **Python (Flask)**, **C**, **HTML/CSS/JavaScript**, and **OpenStreetMap (OSM)** for real-time path visualization. After logging in, users access an interactive map where they can select campus blocks, view details, and get directions using optimized pathfinding algorithms like **Dijkstra**, **A\***, and **Floyd-Warshall**.

The system calculates accurate distances using the **Vincenty formula**, shows walkable steps and estimated time, and displays the route on OSM. A **chatbot assistant** is also included for interactive help.
